    ...
    <div id="modDisclaimer">
      ...
      <div class="mod-about">
        <div class="inner">
          ...
          <p>
            <span id="lang-dclt">For security purposes, please check: <a href="http://www.startrekguide.com/community/">http://www.startrekguide.com/community/</a> for the latest version of this MOD. Downloading this MOD from other sites could cause malicious code to enter into your phpBB Forum. As such, phpBB will not offer support for MODs not offered in our MODs database, located at: <a href="http://www.startrekguide.com/community/">http://www.startrekguide.com/community/</a></span>
          </p>
          <span class="corners-bottom">
            <span></span>
          </span>
